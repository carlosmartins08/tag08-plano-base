...
export const es: TranslationSchema = {
  "nicheHeadlines": {
    ...
    "tech": "Escalabilidad digital de élite.",
    "expert": "Tu autoridad merece una vitrina de élite.",
    "generic": "Venda más."
  },
  "hero": {
  ...
  "valueProposition": {
    ...
    "title": "Marketing sin metodo se vuelve costo.",
    "titleAccent": "Con estructura, se vuelve crecimiento.",
    "subtitle": "TAG08 organiza el ciclo completo: planificacion, ejecucion y lectura de rendimiento. No recibes volumen suelto; recibes direccion con criterio de negocio.",
    "features": {
      "focus": {
        "title": "Foco en la operacion",
        "desc": "Mientras tu equipo vende y entrega, nuestro equipo cuida posicionamiento, contenido y cadencia."
      },
      "data": {
        "title": "Decision con datos",
        "desc": "Informes objetivos muestran donde hubo ganancia real y donde conviene reasignar esfuerzo."
      },
      "scale": {
        "title": "Crecimiento con proceso",
        "desc": "Cada ciclo cierra con aprendizajes aplicados al mes siguiente para evitar retrabajo e improvisacion."
      }
    },
  ...
  "pillars": {
    ...
    "items": {
      "strategy": {
        ...
        "desc": "Definicion de canales, personas, linea editorial y calendario trimestral de acciones con foco en conversion."
      },
      "content": {
      ...
      "ads": {
        ...
        "desc": "Configuracion y optimizacion diaria de campanas en Meta Ads y Google Ads para maximizar el ROI."
      },
      "analysis": {
  ...
  "cookie": {
    ...
    "desc": "Utilizamos cookies para optimizar su experiencia y analizar nuestro trafico.",
    "accept": "Aceptar",
  ...
  "cookiePolicy": {
    ...
    "sections": {
      ...
      "management": {
        ...
        "text": "Puede gestionar o desactivar las cookies desde la configuracion de su navegador en cualquier momento. Tenga en cuenta que desactivarlas puede afectar su experiencia en el sitio."
      }
    }
  },
  "monthlyCycle": {
  ...
  "testimonials": {
    "title": "Lo que los clientes notan en la practica",
    "subtitle": "El feedback repetido no habla de promesas. Habla de proceso claro, rutina ordenada y decisiones mas seguras.",
    "googleRating": "5.0",
    "reviewCount": "mas de 40 resenas reales",
    ...
    "items": [
      {
        ...
        "role": "CEO, TechFlux",
        "content": "Pasamos de publicaciones dispersas a un calendario con prioridad y criterio. En pocas semanas el impacto comercial fue mas claro.",
        "date": "hace 2 meses"
      },
      {
        "name": "Fernanda Costa",
        "role": "Dir. de Marketing, Lumina",
        "content": "La diferencia principal fue la organizacion: cada entrega llega con objetivo, contexto y siguiente paso.",
        "date": "hace 1 mes"
      },
      {
        "name": "Bruno Mantovani",
        "role": "Socio, Nexus Invest",
        "content": "Hoy decidimos con mas seguridad porque el equipo muestra que subio, que bajo y que se ajustara.",
        "date": "hace 3 semanas"
      }
    ],
    "badge": "Testimonios"
  ...
  "videoGallery": {
    "badge": "Resultados en la practica",
    "title": "La ejecucion no queda en discurso.",
    "titleAccent": "Queda visible.",
    "subtitle": "El canal muestra ritmo real de entrega: temas, consistencia de publicacion y evolucion de formato entre ciclos.",
    "updated": "Actualizacion continua",
    "featured": "Contenido destacado",
    "latest": "Contenidos recientes",
    "openChannel": "Acceder al canal",
    "watch": "Ver contenidos producidos",
    "loading": "Cargando contenidos recientes...",
    "error": "No fue posible cargar los contenidos ahora. Accede al canal para ver la biblioteca completa.",
    "previousVideoAria": "Video anterior",
    "nextVideoAria": "Siguiente video"
  },
  "teamShowcase": {
    "badge": "Equipo y estructura",
    "title": "Detras de la estrategia,",
    "titleAccent": "cada frente tiene responsable.",
    "subtitle": "Estrategia, comunicacion y tecnologia trabajan con responsabilidad clara. Ninguna area opera sin criterio ni decision sin contexto.",
    ...
    "items": [
      {
        ...
        "summary": "Carlos define prioridades de ciclo, protege el posicionamiento y alinea cada entrega con objetivo comercial.",
        "focus": "Direccion",
        "tags": [
          "Direccion",
          "Prioridad",
      ...
      {
        "name": "Ignacio Quiroz",
        "role": "Estrategia y comunicacion",
        "summary": "Ignacio convierte objetivos de negocio en narrativa, oferta y mensajes que el cliente entiende rapido.",
        "focus": "Estrategia",
        "tags": [
          "Narrativa",
          "Oferta",
      ...
      {
        "name": "Pedro V. Félix",
        "role": "Datos y tecnologia",
        "summary": "Pedro estructura datos, automatizaciones e integraciones para mostrar que funciona y que debe recortarse.",
        "focus": "Tecnologia",
        "tags": [
          "Datos",
          "Integracion",
    ...
    "support": "Modelo de trabajo: ownership claro, checkpoints recurrentes y ajuste rapido cuando el dato pide cambio."
  },
  "strategicBenefits": {
