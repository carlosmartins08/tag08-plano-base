...
export const pt: TranslationSchema = {
  ...
  "valueProposition": {
    ...
    "title": "Marketing sem metodo vira custo.",
    "titleAccent": "Com estrutura, vira crescimento.",
    "subtitle": "A TAG08 organiza o ciclo completo: planejamento, execucao e leitura de resultado. Voce nao recebe volume solto; recebe direcao com criterio de negocio.",
    "features": {
      "focus": {
        "title": "Foco na operacao",
        "desc": "Enquanto sua equipe vende e entrega, nossa equipe cuida de posicionamento, conteudo e cadencia."
      },
      "data": {
        "title": "Decisao com dados",
        "desc": "Relatorios objetivos mostram onde houve ganho real e onde o esforco precisa ser realocado."
      },
      "scale": {
        "title": "Crescimento com processo",
        "desc": "Cada ciclo fecha com aprendizados aplicados no mes seguinte, evitando retrabalho e improviso."
      }
    },
  ...
  "testimonials": {
    "title": "O que os clientes notam na pratica",
    "subtitle": "A percepcao recorrente nao e sobre promessa. E sobre processo claro, rotina organizada e decisao mais segura.",
    "googleRating": "5.0",
    "reviewCount": "mais de 40 avaliacoes reais",
    ...
    "items": [
      {
        ...
        "role": "CEO, TechFlux",
        "content": "Saiamos de publicacoes sem direcao. Em poucas semanas passamos a ter calendario, criterio e impacto comercial mais previsivel.",
        "date": "há 2 meses"
      },
      {
        "name": "Fernanda Costa",
        "role": "Dir. de Marketing, Lumina",
        "content": "A diferenca foi a organizacao: cada entrega ja chega com objetivo, contexto e proximo passo definido.",
        "date": "há 1 mês"
      },
      {
        "name": "Bruno Mantovani",
        "role": "Sócio, Nexus Invest",
        "content": "Hoje conseguimos decidir com mais tranquilidade porque o time mostra o que performou, o que caiu e o que sera ajustado.",
        "date": "há 3 semanas"
      }
    ],
    "badge": "Depoimentos"
  ...
  "videoGallery": {
    "badge": "Resultados na pratica",
    "title": "A execucao nao fica no discurso.",
    "titleAccent": "Ela fica visivel.",
    "subtitle": "O canal mostra rotina real de entrega: temas, consistencia de publicacao e evolucao de formato ao longo dos ciclos.",
    "updated": "Atualizacao continua",
    "featured": "Conteudo em destaque",
    "latest": "Conteudos recentes",
    "openChannel": "Acessar canal",
    "watch": "Ver conteudos produzidos",
    "loading": "Carregando conteudos recentes...",
    "error": "Nao foi possivel carregar os conteudos agora. Acesse o canal para ver a biblioteca completa.",
    "previousVideoAria": "Video anterior",
    "nextVideoAria": "Proximo video"
  },
  "teamShowcase": {
    "badge": "Time e estrutura",
    "title": "Por tras da estrategia,",
    "titleAccent": "existe dono de cada frente.",
    "subtitle": "Aqui, estrategia, comunicacao e tecnologia trabalham com responsabilidade definida. Nao existe area sem criterio nem decisao sem contexto.",
    "featuredLabel": "Liderança ativa",
    "openProfile": "Abrir perfil",
    "items": [
      {
        "name": "Carlos Martins",
        "role": "Direcao estrategica",
        "summary": "Carlos define prioridade de ciclo, protege o posicionamento e alinha cada entrega com objetivo comercial.",
        "focus": "Direcao",
        "tags": [
          "Direcao",
          "Prioridade",
      ...
      {
        "name": "Ignacio Quiroz",
        "role": "Estrategia e comunicacao",
        "summary": "Ignacio transforma objetivo de negocio em narrativa, oferta e mensagens que o cliente entende rapido.",
        "focus": "Estrategia",
        "tags": [
          "Narrativa",
          "Oferta",
      ...
      },
      {
        ...
        "summary": "Pedro estrutura dados, automacoes e integracoes para dar visibilidade do que funciona e do que precisa corte.",
        "focus": "Tecnologia",
        "tags": [
          "Dados",
          "Integracao",
    ...
    "support": "Modelo de trabalho: responsabilidade clara, checkpoint recorrente e ajuste rapido quando o dado pede mudanca."
  },
  "strategicBenefits": {
    "badge": "A norma TAG08",
    "title": "A norma TAG08",
