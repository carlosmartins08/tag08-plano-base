...
export const fr: TranslationSchema = {
  ...
  "valueProposition": {
    "badge": "Proposition de valeur",
    "title": "Le marketing sans methode devient un cout.",
    "titleAccent": "Avec structure, il devient croissance.",
    "subtitle": "TAG08 structure le cycle complet: planification, execution et lecture de performance. Vous ne recevez pas un volume aleatoire, mais une direction reliee aux objectifs business.",
    "features": {
      "focus": {
        "title": "Focus operationnel",
        "desc": "Pendant que votre equipe vend et delivre, notre equipe pilote positionnement, contenu et cadence."
      },
      "data": {
        "title": "Decision appuyee par les donnees",
        "desc": "Des rapports objectifs montrent ou le gain est reel et ou il faut reallouer le temps."
      },
      "scale": {
        "title": "Croissance avec processus",
        "desc": "Chaque cycle se termine avec des apprentissages appliques au mois suivant, pour reduire rework et improvisation."
      }
    },
  ...
  "privacy": {
    ...
    "sections": {
      ...
      "cookies": {
        ...
        "text": "Nous utilisons des cookies techniques pour garantir le fonctionnement du site et des cookies analytiques (Google Analytics) afin dameliorer la diffusion de contenu."
      },
      "rights": {
        "title": "Vos Droits",
  ...
  "testimonials": {
    ...
    "subtitle": "Le retour recurrent ne parle pas de promesses, mais de processus clair, routine organisee et decisions plus sures.",
    "googleRating": "5.0",
    "reviewCount": "plus de 40 avis reels",
    "reviewCountLabel": "avis",
    "sourceLabel": "Profil Google Business",
    "viewAll": "Voir tous les temoignages",
    "items": [
      {
        "name": "Ricardo Almeida",
        "role": "CEO, TechFlux",
        "content": "Nous sommes passes de publications dispersees a un calendrier avec priorites claires. En quelques semaines, impact commercial plus lisible.",
        "date": "il y a 2 mois"
      },
      {
        "name": "Fernanda Costa",
        "role": "Dir. Marketing, Lumina",
        "content": "La vraie difference: organisation. Chaque livraison arrive avec objectif, contexte et prochaine action.",
        "date": "il y a 1 mois"
      },
      {
  ...
  "videoGallery": {
    "badge": "Resultats en pratique",
    "title": "Lexecution ne reste pas en discours.",
    "titleAccent": "Elle reste visible.",
    "subtitle": "La chaine montre le rythme reel de livraison: themes, constance de publication et evolution de format entre cycles.",
    "updated": "Mise a jour continue",
    "featured": "Contenu en vedette",
    "latest": "Contenus recents",
    "openChannel": "Acceder a la chaine",
    "watch": "Voir les contenus produits",
    "loading": "Chargement des contenus recents...",
    "error": "Impossible de charger les contenus pour le moment. Accedez a la chaine pour voir la bibliotheque complete.",
    "previousVideoAria": "Video precedente",
    "nextVideoAria": "Video suivante"
  },
  "teamShowcase": {
    "badge": "Equipe et structure",
    "title": "Derriere la strategie,",
    "titleAccent": "chaque front a un responsable.",
    "subtitle": "Strategie, communication et technologie avancent avec responsabilite claire. Aucune zone sans critere, aucune decision sans contexte.",
    "featuredLabel": "Leadership actif",
    "openProfile": "Ouvrir le profil",
    "items": [
      {
        "name": "Carlos Martins",
        "role": "Direction strategique",
        "summary": "Carlos definit les priorites de cycle, protege le positionnement et aligne chaque livraison avec l objectif commercial.",
        "focus": "Direction",
        "tags": [
          "Direction",
          "Priorite",
      ...
      {
        "name": "Ignacio Quiroz",
        "role": "Strategie et communication",
        "summary": "Ignacio transforme objectifs business en narration, offre et messages compris rapidement par le client.",
        "focus": "Strategie",
        "tags": [
          "Narration",
          "Offre",
    ...
    "support": "Modele: ownership clair, checkpoints recurrents et ajustement rapide quand la donnee exige un changement."
  },
  "strategicBenefits": {
