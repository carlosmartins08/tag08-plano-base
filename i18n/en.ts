...
export const en: TranslationSchema = {
  ...
  "valueProposition": {
    ...
    "title": "Marketing without method becomes cost.",
    "titleAccent": "With structure, it becomes growth.",
    "subtitle": "TAG08 structures the full cycle: planning, execution, and performance reading. You do not get random volume; you get direction tied to business criteria.",
    "features": {
      "focus": {
        "title": "Operational focus",
        "desc": "While your team sells and delivers, our team handles positioning, content, and cadence."
      },
      "data": {
        "title": "Data-backed decisions",
        "desc": "Objective reports show where real gains happened and where effort should be reallocated."
      },
      "scale": {
        "title": "Process-driven growth",
        "desc": "Each cycle closes with learnings applied to the next month, reducing rework and improvisation."
      }
    },
  ...
  "testimonials": {
    "title": "What clients notice in practice",
    "subtitle": "The recurring feedback is not about hype. It is about clear process, organized routine, and safer decisions.",
    "googleRating": "5.0",
    "reviewCount": "over 40 real reviews",
    "reviewCountLabel": "reviews",
    "sourceLabel": "Google Business Profile",
    "viewAll": "See all testimonials",
    "items": [
      {
        "name": "Ricardo Almeida",
        "role": "CEO, TechFlux",
        "content": "We moved from scattered posting to a clear calendar with priorities. In a few weeks, commercial impact became easier to track.",
        "date": "2 months ago"
      },
      {
        "name": "Fernanda Costa",
        "role": "Marketing Dir., Lumina",
        "content": "The biggest difference was organization: each delivery arrives with objective, context, and next action.",
        "date": "1 month ago"
      },
      {
        "name": "Bruno Mantovani",
        "role": "Partner, Nexus Invest",
        "content": "Decisions are calmer now because the team shows what improved, what dropped, and what will change next.",
        "date": "3 weeks ago"
      }
    ],
    "badge": "Testimonials"
  ...
  "videoGallery": {
    "badge": "Results in practice",
    "title": "Execution does not stay in slides.",
    "titleAccent": "It stays visible.",
    "subtitle": "The channel exposes real delivery rhythm: themes, publishing consistency, and format evolution across cycles.",
    "updated": "Continuously updated",
    "featured": "Featured content",
    "latest": "Recent content",
    "openChannel": "Access channel",
    "watch": "View produced content",
    "loading": "Loading recent content...",
    "error": "Could not load content right now. Access the channel to view the full library.",
    "previousVideoAria": "Previous video",
    "nextVideoAria": "Next video"
  },
  "teamShowcase": {
    "badge": "Team and structure",
    "title": "Behind strategy,",
    "titleAccent": "each front has an owner.",
    "subtitle": "Strategy, communication, and technology operate with clear accountability. No area runs without criteria, and no decision runs without context.",
    ...
    "items": [
      {
        ...
        "summary": "Carlos sets cycle priorities, protects positioning, and aligns each delivery with commercial goals.",
        "focus": "Direction",
        "tags": [
          "Direction",
          "Priority",
      ...
      },
      {
        ...
        "summary": "Ignacio turns business goals into narrative, offer framing, and messages customers understand quickly.",
        "focus": "Strategy",
        "tags": [
          "Narrative",
          "Offer",
      ...
      },
      {
        ...
        "summary": "Pedro structures data, automations, and integrations to show what is working and what should be cut.",
        "focus": "Technology",
        "tags": [
          "Data",
          "Integration",
    ...
    "support": "Work model: clear ownership, recurring checkpoints, and fast adjustments when data signals a change."
  },
  "strategicBenefits": {
